                    ...
                    <Row className="g-3">
                        <Col sm={6} md={4}>
                            ...
                            <Stack className="fw-medium">
                                {DisciplineEnum.getOptions(t).find((opt) => opt.value === goal.discipline)?.label ||
                                    goal.discipline}
                            </Stack>
                        </Col>
                        <Col sm={6} md={4}>
                        ...
                        <Col sm={6} md={4}>
                            ...
                            <Stack>
                                <Badge bg="light" text="dark" className="border profile-theme-border">
                                    {GoalStatusEnum.getOptions(t).find((opt) => opt.value === goal.status)?.label ||
                                        goal.status}
                                </Badge>
                            </Stack>
                        </Col>
