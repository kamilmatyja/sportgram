        ...
        <div className="container mt-4 mb-5" style={{'--theme-color': hexColor} as React.CSSProperties}>
            ...
            <div className="card shadow-sm">
                <div className="card-body">
                    ...
                    {loading && friends.length === 0 ? <div className="text-center"><div className="spinner-border"/></div> : (
                        <>
                            ...
                            <div className="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <button className="btn btn-profile-outline-primary mx-2" disabled={friends.length < limit} onClick={onNextPage}>{t('next')}</button>
                            </div>
                        </>
                    )}
                </div>
