...
import { TrainingDetailsParticipantsTable } from './Training/TrainingDetailsParticipantsTable';
import { TrainingDetailsDisciplinesTable } from './Training/TrainingDetailsDisciplinesTable';
