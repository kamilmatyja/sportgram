                                                    ...
                                                    {isExpanded && (hasResult || isFormOpen) && (
                                                        <tr className="bg-light">
                                                            <td colSpan={6} className="p-0">
                                                                {isFormOpen ? (
                                                                    <div className="border rounded border-profile-primary bg-white p-3 m-2">
                                                                    ...
                                                                    <div className="p-3 border rounded border-profile-primary m-2 bg-white">
                                                                        <div className="d-flex justify-content-between align-items-center mb-2">
                                                                            <strong className="text-profile-primary">{t('eventTypes.eventDisciplineResult')}</strong>
                                                                            {(isEventOwner || isAdmin) && (
                                                                                <div>
                                                                                    <button className="btn btn-sm btn-outline-secondary me-1 py-0" onClick={() => openEditResultForm(list, result.id)}>
                                                                                        <i className="bi bi-pencil"></i>
                                                                                    </button>
                                                                                    <button className="btn btn-sm btn-outline-danger py-0" disabled={interactions.actionLoading === 'delete_result'} onClick={() => deleteResult(result.id)}>
                                                                                        <i className="bi bi-trash"></i>
                                                                                    </button>
                                                                                </div>
                                                                            )}
