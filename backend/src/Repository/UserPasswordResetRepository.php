...
class UserPasswordResetRepository extends ServiceEntityRepository
{
    ...
    final public function findById(string $id): ?UserPasswordReset
    {
        /** @var ?UserPasswordReset $userPasswordReset */
        $userPasswordReset = $this->find($id);

        return $userPasswordReset;
    }

    final public function findLastByUserId(string $userId): ?UserPasswordReset
    {
        /** @var ?UserPasswordReset $userPasswordReset */
