...
class ConversationSenderVoter extends Voter
{
    public const string CONVERSATION_SENDER = 'CONVERSATION_SENDER';
    ...
    {
        return $attribute === self::CONVERSATION_SENDER && $subject !== null;
    }
    ...
    final protected function voteOnAttribute(
        ...
        if ($conversation && $conversation->senderUser->id?->toString() === $user->id?->toString()) {
            return true;
        }
