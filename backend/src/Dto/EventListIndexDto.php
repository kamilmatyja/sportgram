...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'filter', ref: '#/components/schemas/EventListFilterDto', nullable: true),
    ],
    type: 'object',
)]
class EventListIndexDto
{
    #[Assert\Positive]
    ...
    {
        $this->filter = new EventListFilterDto();
    }
}
