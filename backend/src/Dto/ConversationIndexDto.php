...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'filter', ref: '#/components/schemas/ConversationFilterDto', nullable: true),
    ],
    type: 'object',
)]
class ConversationIndexDto
{
    #[Assert\Positive]
    ...
    #[Assert\Valid]
    public ConversationFilterDto $filter;

    public function __construct()
    {
        $this->filter = new ConversationFilterDto();
    }
}
