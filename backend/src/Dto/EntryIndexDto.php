...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'filter', ref: '#/components/schemas/EntryFilterDto', nullable: true),
    ],
    type: 'object',
)]
class EntryIndexDto
{
    ...
    #[Assert\Valid]
    public EntryFilterDto $filter;

    public function __construct()
    {
        $this->filter = new EntryFilterDto();
    }
}
