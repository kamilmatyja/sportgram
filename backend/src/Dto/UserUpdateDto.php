...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'password', type: 'string', example: 'password123', nullable: true),
        ...
        new OA\Property(property: 'disciplines', type: 'array', items: new OA\Items(type: 'integer'), example: [1]),
    ],
    type: 'object',
)]
class UserUpdateDto
