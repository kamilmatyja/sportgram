...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'birthAt', type: 'string', format: 'date-time', example: '2000-01-01T21:37:00'),
        ...
        new OA\Property(property: 'email', type: 'string', example: 'jan@kowalski.pl'),
